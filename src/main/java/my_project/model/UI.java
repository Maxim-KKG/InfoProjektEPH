...
public class UI extends GraphicalObject {
    ...
    public void draw(DrawTool drawTool) {
        ...
        drawTool.drawFilledRectangle(x + 202,y + 6,(bread/breadNeeded)*500,5);
        drawTool.setCurrentColor(new Color(36, 159, 222));
        drawTool.drawFilledRectangle(x + 202,y + 11,(bread/breadNeeded)*500,26);
        drawTool.setCurrentColor(new Color(32, 214, 199));
        drawTool.drawFilledRectangle(x + 202,y + 37,(bread/breadNeeded)*500,5);
    }
}
